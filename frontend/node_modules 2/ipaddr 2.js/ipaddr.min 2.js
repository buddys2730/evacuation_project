  ...
  !(function (t) {
    ...
    (h.IPv4 = (function () {
      ...
      (h.IPv4.isValidFourPartDecimal = function (t) {
        return !(
          !h.IPv4.isValid(t) || !t.match(/^(0|[1-9]\d*)(\.(0|[1-9]\d*)){3}$/)
        );
      }),
      ...
      (h.IPv6.broadcastAddressFromCIDR = function (t) {
        try {
          ...
          throw new Error(
            `ipaddr: the address does not have IPv6 CIDR format (${t})`,
          );
        }
      }),
      ...
      (h.IPv6.subnetMaskFromPrefixLength = function (t) {
        ...
        for (; e < n; ) (r[e] = 255), e++;
        return (
          n < 16 && (r[n] = (Math.pow(2, t % 8) - 1) << (8 - (t % 8))),
          new this(r)
        );
      }),
      ...
      (h.subnetMatch = function (t, r, e) {
        ...
        for (i in ((void 0 !== e && null !== e) || (e = "unicast"), r))
          if (Object.prototype.hasOwnProperty.call(r, i))
            for (
              !(o = r[i])[0] || o[0] instanceof Array || (o = [o]), n = 0;
              n < o.length;
              n++
            )
