    ...
    (h.IPv4 = (function () {
      ...
      return (
        (t.prototype.SpecialRanges = {
          ...
          as112: [
            [new t([192, 175, 48, 0]), 24],
            [new t([192, 31, 196, 0]), 24],
          ],
          amt: [[new t([192, 52, 193, 0]), 24]],
        }),
      ...
      (h.IPv4.broadcastAddressFromCIDR = function (t) {
        try {
      ...
      (h.IPv4.isIPv4 = function (t) {
        return null !== this.parser(t);
      }),
      (h.IPv4.isValid = function (t) {
        try {
      ...
      (h.IPv4.isValidFourPartDecimal = function (t) {
        return !(!h.IPv4.isValid(t) || !t.match(/^(0|[1-9]\d*)(\.(0|[1-9]\d*)){3}$/));
      }),
      (h.IPv4.networkAddressFromCIDR = function (t) {
        let r, e, n, i, o;
        try {
          for (
        ...
        return (r = t.match(e.twoOctet))
          ? (function () {
              ...
              if ((i = u(t[1])) > 16777215 || i < 0)
                throw new Error('ipaddr: address outside defined range');
              return (
                e.push(u(t[0])), e.push((i >> 16) & 255), e.push((i >> 8) & 255), e.push(255 & i), e
              );
            })()
      ...
      (h.IPv4.subnetMaskFromPrefixLength = function (t) {
      ...
      (h.IPv6 = (function () {
        function t(t, r) {
          let e, n;
          if (16 === t.length)
            for (this.parts = [], e = 0; e <= 14; e += 2) this.parts.push((t[e] << 8) | t[e + 1]);
          else {
        ...
        return (
          (t.prototype.SpecialRanges = {
            ...
            discard: [new t([256, 0, 0, 0, 0, 0, 0, 0]), 64],
            ...
            benchmarking: [new t([8193, 2, 0, 0, 0, 0, 0, 0]), 48],
            amt: [new t([8193, 3, 0, 0, 0, 0, 0, 0]), 32],
            as112v6: [
              [new t([8193, 4, 274, 0, 0, 0, 0, 0]), 48],
              [new t([9760, 79, 32768, 0, 0, 0, 0, 0]), 48],
            ],
            deprecated: [new t([8193, 16, 0, 0, 0, 0, 0, 0]), 28],
            orchid2: [new t([8193, 32, 0, 0, 0, 0, 0, 0]), 28],
            droneRemoteIdProtocolEntityTags: [new t([8193, 48, 0, 0, 0, 0, 0, 0]), 28],
            reserved: [
              [new t([8193, 0, 0, 0, 0, 0, 0, 0]), 23],
          ...
          (t.prototype.toIPv4Address = function () {
            ...
            const t = this.parts.slice(-2),
              r = t[0],
              e = t[1];
            return new h.IPv4([r >> 8, 255 & r, e >> 8, 255 & e]);
          }),
          (t.prototype.toNormalizedString = function () {
            const t = function () {
              const t = [];
      ...
      (h.IPv6.broadcastAddressFromCIDR = function (t) {
        try {
          const r = this.parseCIDR(t),
            e = r[0].toByteArray(),
            n = this.subnetMaskFromPrefixLength(r[1]).toByteArray(),
      ...
      (h.IPv6.isIPv6 = function (t) {
        return null !== this.parser(t);
      }),
      (h.IPv6.isValid = function (t) {
      ...
      (h.IPv6.networkAddressFromCIDR = function (t) {
        let r, e, n, i, o;
        try {
          for (
            n = (r = this.parseCIDR(t))[0].toByteArray(),
      ...
      (h.IPv6.parse = function (t) {
        const r = this.parser(t);
        if (null === r.parts)
          throw new Error('ipaddr: string is not formatted like an IPv6 Address');
        return new this(r.parts, r.zoneId);
      }),
      (h.IPv6.parseCIDR = function (t) {
        let r, e, n;
      ...
      (h.IPv6.parser = function (t) {
        ...
        if (
          ...
          return (
            ...
            r.parts.push((o[2] << 8) | o[3]),
            { parts: r.parts, zoneId: r.zoneId }
          );
        }
        return null;
      }),
      (h.IPv6.subnetMaskFromPrefixLength = function (t) {
      ...
      (h.fromByteArray = function (t) {
        const r = t.length;
        if (4 === r) return new h.IPv4(t);
        if (16 === r) return new h.IPv6(t);
        throw new Error('ipaddr: the binary input is neither an IPv6 nor IPv4 address');
      }),
      (h.isValid = function (t) {
        return h.IPv6.isValid(t) || h.IPv4.isValid(t);
      }),
      (h.isValidCIDR = function (t) {
        return h.IPv6.isValidCIDR(t) || h.IPv4.isValidCIDR(t);
      }),
      (h.parse = function (t) {
        if (h.IPv6.isValid(t)) return h.IPv6.parse(t);
        if (h.IPv4.isValid(t)) return h.IPv4.parse(t);
        throw new Error('ipaddr: the address has neither IPv6 nor IPv4 format');
      }),
      (h.parseCIDR = function (t) {
        try {
          return h.IPv6.parseCIDR(t);
        } catch (r) {
          try {
            return h.IPv4.parseCIDR(t);
          } catch (t) {
      ...
      'undefined' != typeof module && module.exports ? (module.exports = h) : (t.ipaddr = h);
  })(this);
