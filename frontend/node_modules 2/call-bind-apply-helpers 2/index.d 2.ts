...
type ConcatTuples<Prefix extends readonly unknown[], Suffix extends readonly unknown[]> = [
  ...Prefix,
  ...Suffix,
];

type ExtractFunctionParams<T> = T extends (
  this: infer TThis,
  ...args: infer P extends readonly unknown[]
) => infer R
...
> =
  ExtractFunctionParams<T> extends {
    ...
    ? ReceiverBound extends true
      ? (...args: RemoveFromTuple<P, Extract<TBoundArgs['length'], number>>) => R extends [
          OrigThis,
          ...infer Rest,
        ]
