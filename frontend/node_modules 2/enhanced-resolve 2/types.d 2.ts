...
declare class CachedInputFileSystem {
  ...
  readJson?: (
    ...
    arg1: (arg0: null | Error | NodeJS.ErrnoException, arg1?: JsonObject) => void
  ) => void;
...
declare class CloneBasenamePlugin {
  constructor(
    source: string | AsyncSeriesBailHook<[ResolveRequest, ResolveContext], null | ResolveRequest>,
    target: string | AsyncSeriesBailHook<[ResolveRequest, ResolveContext], null | ResolveRequest>
  );
  source: string | AsyncSeriesBailHook<[ResolveRequest, ResolveContext], null | ResolveRequest>;
  target: string | AsyncSeriesBailHook<[ResolveRequest, ResolveContext], null | ResolveRequest>;
...
declare interface Iterator<T, Z> {
  (item: T, callback: (err?: null | Error, result?: null | Z) => void, i: number): void;
}
...
declare interface LStat {
  (path: PathLike, callback: (arg0: null | NodeJS.ErrnoException, arg1?: IStats) => void): void;
  (
    path: PathLike,
  ...
  (
    ...
    callback: (arg0: null | NodeJS.ErrnoException, arg1?: IStats | IBigIntStats) => void
  ): void;
}
...
declare interface ReadFile {
  ...
  (
    ...
    callback: (arg0: null | NodeJS.ErrnoException, arg1?: string | Buffer) => void
  ): void;
  (
    path: PathOrFileDescriptor,
    callback: (arg0: null | NodeJS.ErrnoException, arg1?: Buffer) => void
...
declare interface ReadFileSync {
  (path: PathOrFileDescriptor, options?: null | { encoding?: null; flag?: string }): Buffer;
  (
    path: PathOrFileDescriptor,
    options:
      | 'ascii'
...
declare interface Readdir {
  ...
  (path: PathLike, callback: (arg0: null | NodeJS.ErrnoException, arg1?: string[]) => void): void;
  (
    path: PathLike,
    options:
      | undefined
...
declare interface ReaddirSync {
  ...
  (
    path: PathLike,
    options: 'buffer' | { encoding: 'buffer'; withFileTypes?: false; recursive?: boolean }
  ): Buffer[];
  (
    path: PathLike,
    options?:
...
type ResolveOptionsOptionalFS = Omit<ResolveOptionsResolverFactoryObject_2, 'fileSystem'> &
...
declare abstract class Resolver {
  ...
  doResolve(
    hook: AsyncSeriesBailHook<[ResolveRequest, ResolveContext], null | ResolveRequest>,
...
declare namespace exports {
  ...
  export function create(options: ResolveOptionsOptionalFS): ResolveFunctionAsync;
  export namespace create {
    export const sync: (options: ResolveOptionsOptionalFS) => ResolveFunction;
  }
  export namespace ResolverFactory {
    export let createResolver: (options: ResolveOptionsResolverFactoryObject_2) => Resolver;
  }
