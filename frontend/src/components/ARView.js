...
const ARView = () => {
  ...
  return (
    <div>
      ...
      >
        <b style={{ fontSize: "1.18em" }}>【AR初回利用時のご案内】</b>
        <br />
        本サービスでは<b>カメラ・位置情報・センサーの許可</b>が必要です。
        <br />
        <ul style={{ margin: "8px 0 0 20px" }}>
          <li>
            「カメラ起動」「AR表示」ボタンを<b>必ずタップ</b>してください。
          </li>
          <li>
            iPhoneの方
            <br />
            1. 設定→Safari→カメラ/位置情報→<b>許可</b>
            <br />
            2. アドレスバー左「AA」→Webサイトの設定→カメラ/位置情報→<b>許可</b>
          </li>
          <li>
            Androidの方：画面下の許可ダイアログを<b>許可</b>してください。
          </li>
