export default function DisasterCardList({ disasters, selectedId, onSelect, onEdit }) {
  return (
      ...
      {disasters.map(d => (
        <div
          ...
          style={{
            ...
            background: d.cleared_at ? "#e7f4ff" : (d.id === selectedId ? "#ffeaea" : "#fff"),
        ...
        >
          ...
          <div style={{ marginTop: 10 }}>
            <button onClick={e => { e.stopPropagation(); onEdit(d); }}>編集</button>
          </div>
        </div>
      ))}
